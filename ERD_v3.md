# LushProtein Database Schema (ERD v3)
...
erDiagram
  silver_orders {
    ...
    string Name "Order Name (LPSG-XXXX)"
    string Tags "Order Tags"
    datetime Cancelled_At "Cancelled At"
    string Cancel_Reason "Cancel: Reason"
    datetime Processed_At "Processed At"
    string Currency "Currency code (sgd / myr / hkd) — normalised to SGD"
    string Source "Shopify Order Source"
    float Price_Total_Line_Items "Price: Total Line Items"
    string Price_Current_Subtotal "Price: Current Subtotal"
    float Price_Subtotal "Price: Subtotal"
    float Price_Total_Discount "Price: Total Discount"
    string Price_Current_Total_Shipping "Price: Current Total Shipping"
    float Price_Total_Shipping "Price: Total Shipping"
    float Price_Total_Refund "Price: Total Refund"
    string Price_Current_Total "Price: Current Total"
    float Price_Total "Price: Total (SGD)"
    string Payment_Status "Payment: Status"
    string Order_Fulfillment_Status "Order Fulfillment Status"
    string Customer_ID FK "Customer: ID (Shopify Customer ID)"
    string Customer_Tags "Customer: Tags"
    string Customer_Email_Marketing_Status "Customer: Email Marketing Status"
    string Customer_SMS_Marketing_Status "Customer: SMS Marketing Status"
    string Shipping_Zip "Shipping: Zip"
    string Shipping_City "Shipping: City"
    string Shipping_Province "Shipping: Province"
    string Shipping_Province_Code "Shipping: Province Code"
    string Shipping_Country "Shipping: Country"
    string Shipping_Country_Code "Shipping: Country Code"
    string Browser_Landing_Page "Browser: Landing Page"
    string Browser_Referrer "Browser: Referrer"
    string Browser_Referrer_Domain "Browser: Referrer Domain"
    string Browser_UTM_Source "Browser: UTM Source"
    string Browser_UTM_Medium "Browser: UTM Medium"
    string Browser_UTM_Campaign "Browser: UTM Campaign"
    string Browser_UTM_Content "Browser: UTM Content"
    string Top_Row "Top Row (header flag)"
    string Line_Type "Line: Type"
    string Line_ID "Line: ID"
    string Line_Product_ID "Line: Product ID"
    string Line_Product_Handle "Line: Product Handle"
    string Line_Title "Line: Title"
    string Line_Name "Line: Name"
    string Line_Variant_ID "Line: Variant ID"
    string Line_Variant_Title "Line: Variant Title"
    string Line_SKU "Line: SKU"
    float Line_Quantity "Line: Quantity"
    float Line_Price "Line: Price (SGD)"
    float Line_Discount "Line: Discount (SGD)"
    string Line_Discount_Allocation "Line: Discount Allocation"
    float Line_Discount_Per_Item "Line: Discount per Item (SGD)"
    float Line_Total "Line: Total (SGD)"
    string Line_Requires_Shipping "Line: Requires Shipping"
    string Line_Vendor "Line: Vendor"
    string Line_Variant_SKU FK "Line: Variant SKU"
    string Line_Variant_Inventory_Qty "Line: Variant Inventory Qty"
    string Line_Variant_Cost "Line: Variant Cost"
    string Line_Variant_Price "Line: Variant Price"
  }
  silver_products {
  ...
  silver_sessions {
    ...
    string _source_file "Source file (ingestion tracking)"
  }
...
erDiagram
  ...
  silver_orders {
    ...
    string Currency "sgd / myr / hkd — all normalised to SGD"
  }
  silver_products {
